...
const PENDING_ACTION_KEY = "pendingBidAction";
...
export default function BID() {
  ...
  const openBidFolder = (project) => {
    ...
    const bidFolder = project.subfolders.find((sf) => sf.name === "BID");
    if (!bidFolder) {
      Swal.fire({
        icon: "info",
        title: "No BID folder",
        text: "BID folder not found in this project.",
      });
      return;
    }

    const url = `https://drive.google.com/drive/folders/${bidFolder.drive_folder_id}`;
      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-0">
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-600 bricolage-grotesque text-sm md:text-base mt-1">
            Scan specifications and manage BID logs
          </p>
        </div>
