    ...
    <div className="min-h-screen bg-[#f5f1eb]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-6 ">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          {/* Terms Title at Top */}
          <h1 className=" flex text-2xl justify-center items-center font-blod text-cyan-400 mb-2">
            Privacy
          </h1>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-cyan-400 hover:bg-cyan-500 text-white font-medium py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg"
              >
                Accept
              </button>
              <button
                onClick={handleDecline}
                className="flex-1 bg-white hover:bg-gray-50 text-cyan-400 font-medium py-3 px-6 rounded-xl border-2 border-cyan-400 transition-all duration-200 transform hover:scale-105"
              >
                Decline
              </button>
            </div>
